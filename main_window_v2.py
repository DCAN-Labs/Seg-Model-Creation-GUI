...
class Ui_MainWindowV2(object):
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("MainWindow")
        MainWindow.resize(892, 820)
        ...
        self.gridLayout.addWidget(self.label_synth_path, 2, 0, 1, 1)

        self.line_synth_path = QtWidgets.QLineEdit(self.centralwidget)
        self.line_synth_path.setObjectName("line_synth_path")
        self.gridLayout.addWidget(self.line_synth_path, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_task_path, 4, 0, 1, 1)

        self.line_task_path = QtWidgets.QLineEdit(self.centralwidget)
        self.line_task_path.setObjectName("line_task_path")
        self.gridLayout.addWidget(self.line_task_path, 5, 0, 1, 1)
        ...
        self.label_dataset_name.setMaximumSize(QtCore.QSize(300, 20))
        self.label_dataset_name.setObjectName("label_dataset_name")
        self.gridLayout.addWidget(self.label_dataset_name, 20, 0, 1, 1)

        self.line_dataset_name = QtWidgets.QLineEdit(self.centralwidget)
        self.line_dataset_name.setObjectName("line_dataset_name")
        self.gridLayout.addWidget(self.line_dataset_name, 21, 0, 1, 1)

        # model type  (infant or lifespan — used by resize_images)
        self.label_model_type = QtWidgets.QLabel(self.centralwidget)
        self.label_model_type.setMaximumSize(QtCore.QSize(300, 20))
        self.label_model_type.setObjectName("label_model_type")
        self.gridLayout.addWidget(self.label_model_type, 22, 0, 1, 1)

        self.line_model_type = QtWidgets.QLineEdit(self.centralwidget)
        ...
        self.comboBox_preset.setFixedSize(200, 30)
        ...
        # checkboxes
        self.checkBoxes = []
        run_list = ['Resize Images', 'Mins/Maxes', 'SynthSeg Image Creation', 'Copying SynthSeg Images Over',
                    'Create JSON File', 'Plan and Preprocess', 'Training the Model', 'Running Inference']
        for i in range(8):
            cb = QCheckBox(run_list[i], self.centralwidget)
            cb.setObjectName(f'checkBox_{i}')
            self.gridLayout.addWidget(cb, i + 8, 2, 1, 1)
            cb.setChecked(True)
            self.checkBoxes.append(cb)

        # info label above checkboxes
        ...
        self.gridLayout.addWidget(self.pushButton, 24, 0, 1, 1, QtCore.Qt.AlignRight | QtCore.Qt.AlignBottom)
        ...
        self.gridLayout.addWidget(self.button_clear, 24, 0, 1, 1, QtCore.Qt.AlignLeft | QtCore.Qt.AlignBottom)
        ...
        # browse buttons (4 path fields)
        self.button_browse_1 = QtWidgets.QPushButton(self.centralwidget)
        self.button_browse_1.setObjectName("button_browse_1")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_dataset_name.setText(_translate("MainWindow", "Dataset Name (e.g. AnomalousInfant)"))
        self.label_model_type.setText(_translate("MainWindow", "Model Type (infant, lifespan)"))
